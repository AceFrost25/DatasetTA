...
# MAX_RADIUS = 0.12
# MAX_RADIUS = 0.11  # ammeter
#MAX_RADIUS = 0.15  # realsensebox


#MAX_RADIUS = 0.1  # powder
#MAX_RADIUS = 0.12  # selai
#MAX_RADIUS = 0.4  # teh
#MAX_RADIUS = 0.25  # sampo
#MAX_RADIUS = 0.12  # deodoran
#MAX_RADIUS = 0.16  # parfum
#MAX_RADIUS = 0.11  # vitaminc
#MAX_RADIUS = 0.11  # lilin
#MAX_RADIUS = 0.12  # sofel
#MAX_RADIUS = 0.15  # kopi
#MAX_RADIUS = 0.16  # popmi
#MAX_RADIUS = 0.9  # powerbank
#MAX_RADIUS = 0.16  # kotak
#MAX_RADIUS = 0.16  # rubik
#MAX_RADIUS = 0.14  # viks
MAX_RADIUS = 0.14  # viks
    ...
    for path in folders:
        ...
        if MESHING:
             # attempt segmentation
              ...
              io.write_triangle_mesh(path + 'registeredScene.ply', mesh, write_ascii=True)
              print("Mesh saved")
              exit()
